...
#define R1_PIN GPIO_PIN 0

#define R2_PORT GPIOA
#define R2_PIN GPIO_PIN 1

#define R3_PORT GPIOA
#define R3_PIN GPIO_PIN 2

#define R4_PORT GPIOA
#define R4_PIN GPIO_PIN 3

#define C1_PORT GPIOA
#define C1_PIN GPIO_PIN 4

#define C2_PORT GPIOA
#define C2_PIN GPIO_PIN 5

#define C3_PORT GPIOC
#define C3_PIN GPIO_PIN 5
